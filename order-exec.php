<?php
    ...
    if(mysql_num_rows($qry_select)>0 && isset($_GET['id'])){
	        ...
	        //Create INSERT query
	        $qry_create = "INSERT INTO orders_details(member_id,billing_id,cart_id,delivery_date,flag,time_stamp,StaffID) VALUES('$member_id','$billing_id','$id','$delivery_date','$flag_0','$time_stamp','0')";
